"""
Satellite Foundation Model - Dataset
"""
import os
import torch
...
class SatelliteFoundationModelDataset(Dataset):
    """Dataset for satellite foundation model."""
...
def get_dataloader(root, split, config):
    ...
    dataset = SatelliteFoundationModelDataset(root, split, transform)
    return DataLoader(
        dataset,
