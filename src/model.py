"""
Satellite Foundation Model - Model Architecture
"""
import torch
...
class SatelliteFoundationModel(nn.Module):
    """
    Main model for satellite foundation model.
    """
...
def build_model(config):
    model = SatelliteFoundationModel(config)
